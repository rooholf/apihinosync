...
class SptrnsinvoiceController extends Controller
{
        ...
        if (!$header) {
            ...
            if ($sptrnsinvoicehdr) {
                Sptrnsinvoicedtl::firstOrCreate([
                    ...
                    'NetSalesAmt' =>
                        $request->QtyBill * $request->RetailPrice -
                        $request->ItemDiscAmt,
    ...
    public function updateHeader(
        ...
        Sptrnsinvoicehdr::where('InvoiceNo', $invno)->update([
            'TotSalesQty' => $totqty,
            'TotDiscAmt' => $totdisc,
            'TotSalesAmt' => $totamt,
            'TotDPPAmt' => $totdpp,
        ...
        Sptrnsfpjhdr::where('FPJNo', $fpjno)->update([
            'TotSalesQty' => $totqty,
            'TotSalesAmt' => $totamt,
            'TotDiscAmt' => $totdisc,
            'TotDPPAmt' => $totdpp,
